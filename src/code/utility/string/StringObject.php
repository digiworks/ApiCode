...
use code\base\utility\ClonableObject;
use code\base\utility\string\StringableInterface;
use Countable;
...
class StringObject extends ClonableObject implements Countable, ArrayAccess, IteratorAggregate, StringableInterface {
    ...
    public function stripHtmlTags(?string $allowTags = null) {
        return $this->cloneInstance(function (self $new) use ($allowTags) {
